...
def add_employee():
    if txtName.get() == "" or txtAge.get() == "" or txtDoj.get() == "" or txtEmail.get() == "" or txtContact.get() == "" or txtAddress.get(
        1.0, END) == "":
...
tree_frame.place(x=0, y=480, width=1950, height=500)
style = ttk.Style()
style.configure("mystyle.Treeview", font=("Calibri", 18),
                rowheight=50)  # Modify the font of the body
style.configure("mystyle.Treeview.Heading", font=("Calibri", 18))  # Modify the font of the body
